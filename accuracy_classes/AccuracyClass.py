...
class AccuracyClass:
    ...
    distance_mse_a: float = None
    distance_mse_b: float = None
    ...
    def __post_init__(self):
        ...
        self.distance_mse_b = 0 if self.distance_mse_b is None else self.distance_mse_b
    ...
    def __repr__(self):
        return (f"AccuracyClass(angle_mse={round(self.angle_mse * 206265, 1) if self.angle_mse is not None else None}, "
                ...
                f"distance_mse={self.distance_mse_a} + {self.distance_mse_b}ppm, "
