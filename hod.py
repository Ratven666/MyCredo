...
st1.add_measurement(HorizontalDistance(start_point=p1, end_point=p0))
st1.add_measurement(HorizontalDistance(start_point=p1, end_point=p2))
...
st2.add_measurement(HorizontalDistance(start_point=p2, end_point=p3))
...
st3.add_measurement(HorizontalDistance(start_point=p3, end_point=p4))
...
st4.add_measurement(HorizontalDistance(start_point=p4, end_point=p3))
st4.add_measurement(HorizontalDistance(start_point=p4, end_point=p5))
